...
- dados: É uma variavel do tipo "MeusDados" da classe "MeusDados", que serve para guardar os dados dos pedidos dos clientes proveninetes da base da base de dados.
